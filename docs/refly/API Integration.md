...
### Example Code
```bash
API_BASE_URL="https://api.refly.ai/v1"
CANVAS_ID="c-cxcin1htmspl8xq419kzseii"
...
const API_BASE_URL = "https://api.refly.ai/v1";
const API_KEY = "YOUR_API_KEY";
const CANVAS_ID = "c-cxcin1htmspl8xq419kzseii";
...
| `data.workflowPlan.variables[].variableType` | string \| option \| resource | No | Variable type |
...
#### Code Examples
```bash
curl -X POST https://api.refly.ai/v1/openapi/copilot/workflow/generate \
...
url = "https://api.refly.ai/v1/openapi/copilot/workflow/generate"
headers = {
...
```
```javascript
const response = await fetch("https://api.refly.ai/v1/openapi/copilot/workflow/generate", {
  method: "POST",
  headers: {
  "Authorization": "Bearer YOUR_API_KEY",
  "Content-Type": "application/json"
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| `files` | string[] | Yes | Files to upload |
...
#### Code Examples
```bash
curl -X POST https://api.refly.ai/v1/openapi/files/upload \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -F "files=@/path/to/file1.pdf" \
  -F "files=@/path/to/file2.txt"
```
...
url = "https://api.refly.ai/v1/openapi/files/upload"
headers = {
  'Authorization': 'Bearer YOUR_API_KEY'
}
files = [
    ("files", open("/path/to/file1.pdf", "rb")),
    ("files", open("/path/to/file2.txt", "rb"))
]
data = {}
...
const url = "https://api.refly.ai/v1/openapi/files/upload";
const form = new FormData();
form.append("files", fs.createReadStream("/path/to/file1.pdf"));
form.append("files", fs.createReadStream("/path/to/file2.txt"));

const headers = { ...form.getHeaders(), "Authorization": "Bearer YOUR_API_KEY" };
...
| `data.status` | init \| executing \| finish \| failed | No | - |
...
#### Code Examples
```bash
curl -X POST https://api.refly.ai/v1/openapi/workflow/c-cxcin1htmspl8xq419kzseii/run \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{}'
```
...
url = "https://api.refly.ai/v1/openapi/workflow/c-cxcin1htmspl8xq419kzseii/run"
headers = {
  'Authorization': 'Bearer YOUR_API_KEY',
  'Content-Type': 'application/json'
}
...
```
```javascript
const response = await fetch("https://api.refly.ai/v1/openapi/workflow/c-cxcin1htmspl8xq419kzseii/run", {
  method: "POST",
  headers: {
  "Authorization": "Bearer YOUR_API_KEY",
  "Content-Type": "application/json"
...
#### Code Examples
```bash
curl -X POST https://api.refly.ai/v1/openapi/workflow/YOUR_EXECUTION_ID/abort \
  -H "Authorization: Bearer YOUR_API_KEY"
```
```python
import requests

url = "https://api.refly.ai/v1/openapi/workflow/YOUR_EXECUTION_ID/abort"
headers = {
  'Authorization': 'Bearer YOUR_API_KEY'
}
data = {}
...
```
```javascript
const response = await fetch("https://api.refly.ai/v1/openapi/workflow/YOUR_EXECUTION_ID/abort", {
  method: "POST",
  headers: {
  "Authorization": "Bearer YOUR_API_KEY"
}
...
| `data.output[].status` | init \| waiting \| executing \| finish \| failed | No | Action status |
| `data.output[].errorMessage` | string | No | Node error message |
| `data.output[].startTime` | string | No | Node start time |
| `data.output[].endTime` | string | No | Node end time |
...
| `data.output[].messages[].type` | ai \| tool | Yes | Action message type |
...
#### Code Examples
```bash
curl -X GET https://api.refly.ai/v1/openapi/workflow/YOUR_EXECUTION_ID/output \
  -H "Authorization: Bearer YOUR_API_KEY"
```
```python
import requests

url = "https://api.refly.ai/v1/openapi/workflow/YOUR_EXECUTION_ID/output"
headers = {
  'Authorization': 'Bearer YOUR_API_KEY'
}
data = {}
...
```
```javascript
const response = await fetch("https://api.refly.ai/v1/openapi/workflow/YOUR_EXECUTION_ID/output", {
  method: "GET",
  headers: {
  "Authorization": "Bearer YOUR_API_KEY"
}
...
| `data.nodeExecutions[].status` | init \| waiting \| executing \| finish \| failed | No | Action status |
| `data.nodeExecutions[].title` | string | No | Node title |
| `data.nodeExecutions[].errorMessage` | string | No | Node error message |
| `data.createdAt` | string | No | Created time |
...
#### Code Examples
```bash
curl -X GET https://api.refly.ai/v1/openapi/workflow/YOUR_EXECUTION_ID/status \
  -H "Authorization: Bearer YOUR_API_KEY"
```
```python
import requests

url = "https://api.refly.ai/v1/openapi/workflow/YOUR_EXECUTION_ID/status"
headers = {
  'Authorization': 'Bearer YOUR_API_KEY'
}
data = {}
...
```
```javascript
const response = await fetch("https://api.refly.ai/v1/openapi/workflow/YOUR_EXECUTION_ID/status", {
  method: "GET",
  headers: {
  "Authorization": "Bearer YOUR_API_KEY"
}
...
#### Code Examples
```bash
curl -X GET https://api.refly.ai/v1/openapi/workflows \
  -H "Authorization: Bearer YOUR_API_KEY"
```
```python
import requests

url = "https://api.refly.ai/v1/openapi/workflows"
headers = {
  'Authorization': 'Bearer YOUR_API_KEY'
}
data = {}
...
```
```javascript
const response = await fetch("https://api.refly.ai/v1/openapi/workflows", {
  method: "GET",
  headers: {
  "Authorization": "Bearer YOUR_API_KEY"
}
...
| `data.variables[].variableType` | string \| option \| resource | No | Variable type |
...
#### Code Examples
```bash
curl -X GET https://api.refly.ai/v1/openapi/workflows/c-cxcin1htmspl8xq419kzseii \
  -H "Authorization: Bearer YOUR_API_KEY"
```
```python
import requests

url = "https://api.refly.ai/v1/openapi/workflows/c-cxcin1htmspl8xq419kzseii"
headers = {
  'Authorization': 'Bearer YOUR_API_KEY'
}
data = {}
...
```
```javascript
const response = await fetch("https://api.refly.ai/v1/openapi/workflows/c-cxcin1htmspl8xq419kzseii", {
  method: "GET",
  headers: {
  "Authorization": "Bearer YOUR_API_KEY"
}
